...
export default function BottomNavigation() {
  ...
  /*
   * Sur l'accueil cette navigation est masquée
   * car app/page.tsx possède sa propre barre.
   */
  if (pathname === "/") {
    return null;
  }
   ...
   *
   * IMPORTANT :
   * /signalement  = créer un signalement
   * /signalements = consulter les signalements
   */
