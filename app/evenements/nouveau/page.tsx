  ...
  useEffect(() => {
    async function initialize() {
      try {
        ...
        if (!user) {
          router.replace(
            "/login?redirect=/evenements/nouveau"
          );
  ...
  async function handleSubmit(
    ...
    try {
      ...
      if (isAdmin) {
        ...
        alert(
          "Votre événement a bien été soumis. Il sera publié après contrôle par un administrateur."
        );
    ...
    >
      ...
      >
        ...
        <div>
          ...
          >
            {isAdmin
              ? "Ajoutez une journée animale, une collecte, une tombola, une journée adoption ou tout autre événement solidaire."
              : "Proposez votre événement. Il sera soumis au contrôle d’un administrateur avant sa publication sur TAUI TE ORA."}
          </p>
        </div>
              ...
              {isAdmin ? (
                ...
                >
                  ...
                  <p
                    ...
                    "
                  >
                    Votre événement sera contrôlé par un administrateur de TAUI TE ORA avant sa publication. Vous recevrez une notification après validation.
                  </p>
                </div>
              )}
